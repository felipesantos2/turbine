    <div class="relative border-t border-gray-200 bg-gray-50">
        ...
        <div class="relative mx-auto max-w-7xl px-6 pt-16 pb-12 sm:px-12 lg:pt-24">
            <header class="mx-auto max-w-2xl text-center">
                <h1 class="text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl">Welcome to my website</h1>
    ...
    <!-- https://tailwindflex.com/@rp-ketan/header-with-svg-background -->
